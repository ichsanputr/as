...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="text-[#0088CC] border-[#0088CC] border-b-2 mt-5 mb-6 text-xl sm:text-2xl font-semibold py-3" data-v-940c9ca4><span data-v-940c9ca4>Berita Terbaru</span></div><div class="mb-10" data-v-940c9ca4><!--[-->`);
      ssrRenderList(unref(news), (news2) => {
        _push(`<div class="cursor-pointer px-0 py-3 flex" data-v-940c9ca4><div class="w-[140px] flex-none" data-v-940c9ca4>`);
        ...
        _push(`</div><div class="block ml-3" data-v-940c9ca4><div class="text-[#0088CC] text-base font-medium" data-v-940c9ca4><span class="line-clamp-2" data-v-940c9ca4>${ssrInterpolate(news2.title)}</span></div><div class="mt-1" data-v-940c9ca4><span data-v-940c9ca4>${ssrInterpolate(unref(moment)(news2.created_at).format("LL"))}</span></div></div></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-940c9ca4"]]);

export { __nuxt_component_3 as _, __nuxt_component_4 as a };
//# sourceMappingURL=LatestNews-c63d642a.mjs.map
