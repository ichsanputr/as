...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="text-[#0088CC] border-[#0088CC] border-b-2 mt-5 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-04ab4e7c><span data-v-04ab4e7c>Potensi Desa Terbaru</span></div><div class="mb-10" data-v-04ab4e7c><!--[-->`);
      ssrRenderList(unref(latestPotensi), (potensi) => {
        _push(`<div class="cursor-pointer mb-2 py-3 flex" data-v-04ab4e7c><div class="w-[140px] flex-none" data-v-04ab4e7c>`);
        ...
        _push(`</div><div class="block ml-3" data-v-04ab4e7c><div class="text-[#0088CC] text-base font-medium" data-v-04ab4e7c><span class="line-clamp-2" data-v-04ab4e7c>${ssrInterpolate(potensi.title)}</span></div><div class="mt-1" data-v-04ab4e7c><span data-v-04ab4e7c>${ssrInterpolate(unref(moment)(potensi.created_at).format("LL"))}</span></div></div></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04ab4e7c"]]);

export { __nuxt_component_4 as _, __nuxt_component_5 as a };
//# sourceMappingURL=LatestPotensi-7282a990.mjs.map
