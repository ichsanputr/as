...
import { f as useRuntimeConfig, e as useToken, _ as _export_sfc } from '../server.mjs';
                  ...
                  if (currentTab.value == "listImage") {
                    ...
                    if (imageSelected.value) {
                      _push3(ssrRenderComponent(_component_v_img, {
                        ...
                        class: "rounded-md",
                        "aspect-ration": "1",
                        "lazy-src": imageSelected.value.url,
                        src: imageSelected.value.url
                    ...
                    _push3(ssrRenderComponent(_component_v_btn, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [
                            !loaderRemove.value ? (openBlock(), createBlock(_component_IconsTrash, { key: 0 })) : (openBlock(), createBlock(_component_Loader, { key: 1 }))
                          ];
                        }
                      }),
                      _: 1
                    }, _parent3, _scopeId2));
                    _push3(`</div></div><div class="${ssrRenderClass([_ctx.$vuetify.display.mobile ? "mt-10" : "mt-0", "w-full md:w-3/4 md:mt-1 px-6 md:px-12 grid grid-cols-2 md:grid-cols-4 gap-8"])}"${_scopeId2}><!--[-->`);
                    ssrRenderList(images.value, (image) => {
                      _push3(`<div class="${ssrRenderClass([{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative h-fit rounded-lg cursor-pointer items-center flex"])}"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_v_img, {
                        width: "100%",
                        class: "rounded-md",
                        "aspect-ratio": "1",
                  ...
                  return [
                    createVNode("div", { class: "w-full" }, [
                      ...
                      currentTab.value == "listImage" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", {
                          class: [_ctx.$vuetify.display.mobile ? "mt-10" : "mt-0", "w-full md:w-3/4 md:mt-1 px-6 md:px-12 grid grid-cols-2 md:grid-cols-4 gap-8"]
                        }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(images.value, (image) => {
                            return openBlock(), createBlock("div", {
                              onClick: ($event) => imageSelected.value = image,
                              class: [{ "border-4 border-[#10B981]": imageSelected.value == image }, "relative h-fit rounded-lg cursor-pointer items-center flex"]
                            }, [
...
//# sourceMappingURL=MediaLibrary-27918fea.mjs.map
