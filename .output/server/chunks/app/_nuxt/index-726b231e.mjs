  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(news), (news2) => {
        _push(`<div class="flex mb-10 cursor-pointer" data-v-913af641><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-913af641>`);
        ...
        _push(`</div><div class="block pl-4" data-v-913af641><div class="text-md md:text-xl font-semibold" data-v-913af641><span class="line-clamp-2" data-v-913af641>${ssrInterpolate(news2.title)}</span></div><div class="text-md flex items-center font-medium mt-1" data-v-913af641>`);
        _push(ssrRenderComponent(_component_IconsDate, null, null, _parent));
        _push(`<span class="text-sm md:text-md ml-1" data-v-913af641>${ssrInterpolate(unref(moment)(news2.created_at).format("LL"))}</span></div><div class="mt-2" data-v-913af641><span class="line-clamp-2 sm:line-clamp-3" data-v-913af641>${ssrInterpolate(news2.description)}</span></div></div></div>`);
      });
      _push(`<!--]-->`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-913af641"]]);
const _sfc_main$4 = {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_v_img = resolveComponent("v-img");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block col-span-4" }, _attrs))} data-v-8db699f7><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-8db699f7><span data-v-8db699f7>Galeri Desa</span></div><div data-v-8db699f7><div id="gallery" class="rounded-lg grid grid-cols-1 md:grid-cols-3 mb-2 gap-6" data-v-8db699f7><!--[-->`);
      ssrRenderList(unref(images), (image, key) => {
        _push(`<div class="rounded-lg h-full w-full relative" data-v-8db699f7><a${ssrRenderAttr("href", image.url)} data-pswp-width="600" data-pswp-height="400" target="_blank" rel="noreferrer" data-v-8db699f7>`);
        _push(ssrRenderComponent(_component_v_img, {
          "lazy-src": image.url,
          class: "rounded-md",
          cover: "",
        ...
        _push(`<div class="rounded-lg z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" data-v-8db699f7><p class="truncate text-sm md:text-base" data-v-8db699f7>${ssrInterpolate(image.description)}</p></div></a></div>`);
      });
      _push(`<!--]--></div></div></div>`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8db699f7"]]);
const _sfc_main$1 = {
  __name: "Location",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=index-726b231e.mjs.map
