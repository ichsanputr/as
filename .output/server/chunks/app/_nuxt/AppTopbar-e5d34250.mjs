...
import { a as useRouter$1, n as navigateTo, e as useToken } from '../server.mjs';
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "block rounded-lg cursor-pointer mt-2 bg-white border border-slate-200 pt-2" }, [
                createVNode("div", {
                  onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/dashboard/profiles"),
...
//# sourceMappingURL=AppTopbar-e5d34250.mjs.map
