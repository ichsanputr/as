...
import { u as useHead, a as useRouter$1, _ as _export_sfc } from '../server.mjs';
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-none" }, _attrs))} data-v-6a5e3a04><div class="grid text-sm sm:text-base grid-cols-1 md:grid-cols-3 gap-x-[6rem] gap-y-8 px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] bg-[#0088CC] text-white py-8" data-v-6a5e3a04><div class="block" data-v-6a5e3a04><div class="text-xl md:text-2xl font-semibold" data-v-6a5e3a04><span data-v-6a5e3a04>Profil</span></div><div class="mt-3 leading-6" data-v-6a5e3a04><span data-v-6a5e3a04>${ssrInterpolate(unref(data).profile)}</span></div></div><div class="block" data-v-6a5e3a04><div class="text-xl md:text-2xl font-semibold" data-v-6a5e3a04><span data-v-6a5e3a04>Sosial Media</span></div><div class="text-sm mt-3" data-v-6a5e3a04><ul data-v-6a5e3a04><!--[-->`);
      ssrRenderList(unref(socialMedia), (item) => {
        _push(`<li class="flex items-center" data-v-6a5e3a04>`);
        ...
        _push(`<a class="ml-1 text-white" target="_blank"${ssrRenderAttr("href", item.link)} data-v-6a5e3a04>${ssrInterpolate(item.name)}</a></li>`);
      });
      _push(`<!--]--></ul></div></div><div class="block" data-v-6a5e3a04><div class="text-xl md:text-2xl font-semibold" data-v-6a5e3a04><span data-v-6a5e3a04>Alamat Lengkap</span></div><div class="mt-3" data-v-6a5e3a04><span data-v-6a5e3a04>${ssrInterpolate(unref(data).address)}</span></div></div></div><div class="bg-[#0077B3] px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] text-white py-5" data-v-6a5e3a04><p class="text-base" data-v-6a5e3a04>${ssrInterpolate(unref(data).copyright)}</p></div></div>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6a5e3a04"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      titleTemplate: "%s - Desa Medalsari"
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=app-4c16c5b5.mjs.map
