...
const __default__ = {
  ...
  methods: {
    ...
    async removeNews() {
      await $fetch(this.$config.public.API_PUBLIC_URL + "/api/admin/" + this.removedNewsId, {
        method: "DELETE",
        headers: {
          Authorization: "Bearer " + useToken().token
        }
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card, {
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><span${_scopeId2}>User yang dihapus tidak bisa dikembalikan kembali dan dapat menyebabkan bug.</span></div>`);
                } else {
                  return [
                    createVNode("div", null, [
                      createVNode("span", null, "User yang dihapus tidak bisa dikembalikan kembali dan dapat menyebabkan bug.")
                    ])
                  ];
                }
              }),
...
//# sourceMappingURL=index-27b5abe5.mjs.map
